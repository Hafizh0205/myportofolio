...
SECRET_KEY = 'django-insecure-p*l5kig&@wai3@zk_-x!3jk*@_z+p6bk)(v+-6k8!=_99*t68r'
...
TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',  # <-- Perhatikan huruf besar/kecilnya
